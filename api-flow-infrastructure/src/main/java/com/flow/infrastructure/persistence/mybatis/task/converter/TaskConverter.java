package com.flow.infrastructure.persistence.mybatis.task.converter;
...
public interface TaskConverter {
    ...
    @Named("saveTaskParamToTaskEntityDO")
    ...
    @Named("updateTaskParamToTaskEntityDO")
    ...
    default Object jsonToObject(String json) {
        return json == null ? null : JsonUtil.toObject(json, Object.class);
    }
    ...
    TaskIDTO taskEntityPOToTaskIDTO(TaskPO taskDO);
