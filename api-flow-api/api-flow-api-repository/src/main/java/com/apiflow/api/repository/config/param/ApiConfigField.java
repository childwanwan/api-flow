...
public enum ApiConfigField implements FieldMetadata {
    ...
    RATE_LIMIT_CONFIG_LIMIT("rateLimitConfig.limit", "rate_limit_config", "limit"),
    RATE_LIMIT_CONFIG_WINDOW_SECONDS("rateLimitConfig.windowSeconds", "rate_limit_config", "windowSeconds"),
