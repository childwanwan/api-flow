        ...
        <div class="layout-sidebar" id="sidebar">
            <ul class="sidebar-menu">
                <li class="menu-item active" data-menu="dashboard">
                    <a href="javascript:void(0);" data-title="运行报表" onclick="openTab('dashboard','${request.contextPath}/dashboard','运行报表',this)">
                ...
                <li class="menu-item" data-menu="api-group,api-config">
                    <a href="javascript:void(0);" data-title="API管理" onclick="toggleSubmenu(this)">
                ...
                <li class="menu-item" data-menu="task,task-log">
                    <a href="javascript:void(0);" data-title="任务中心" onclick="toggleSubmenu(this)">
                ...
                <li class="menu-item" data-menu="user,alarm,plugin,operation-log">
                    <a href="javascript:void(0);" data-title="系统管理" onclick="toggleSubmenu(this)">
            ...
            <div class="sidebar-trigger" onclick="toggleSidebar()" title="收起菜单">
                <span class="trigger-icon">
                    <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M14.71 6.71a.996.996 0 00-1.41 0L8.71 11.3a.996.996 0 000 1.41l4.59 4.59a.996.996 0 101.41-1.41L10.83 12l3.88-3.88c.39-.39.38-1.03 0-1.41z"/></svg>
                </span>
...
document.addEventListener('click', function(e) {
    var dd = document.getElementById('userDropdown');
    if (dd.classList.contains('show') && !dd.contains(e.target)) {
